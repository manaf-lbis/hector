...
router.put('/me/location', auth_middleware_1.authMiddleware, userController.updateLocation.bind(userController));
...
router.patch("/:id/status", auth_middleware_1.authMiddleware, (0, auth_middleware_1.roleMiddleware)([types_1.Roles.admin]), userController.updateUserStatus.bind(userController));
