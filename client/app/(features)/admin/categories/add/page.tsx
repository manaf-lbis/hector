    ...
    return (
        <Container maxWidth="lg" sx={{ py: 6, px: { xs: 2, md: 4 } }}>
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Box>
                    <Typography variant="h4" fontWeight={900}>New Category</Typography>
                    <Typography variant="body2" sx={{ opacity: 0.6, fontWeight: 500 }}>Create a new category for your platform auctions.</Typography>
                </Box>
            </Box>
                            ...
                            <Stack spacing={4}>
                                ...
                                <Box>
                                    ...
                                    <TextField
                                        ...
                                        onChange={handleInputChange}
                                        placeholder="Tell users what kind of auctions belong here..."
                                        sx={{ '& .MuiOutlinedInput-root': { borderRadius: '12px' } }}
                                    />
                                </Box>
                                ...
                                <Box sx={{ pt: 2, display: 'flex', gap: 2 }}>
                                    ...
                                    >
                                        {isLoading ? <CircularProgress size={24} sx={{ color: 'white' }} /> : 'Create Category'}
                                    </AppButton>
                                    <AppButton 
                                        variant="outlined" 
                                        color="secondary"
